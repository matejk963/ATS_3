...
from synth_ord_strategy.constants import BROKER_ID, GAS_YEARS, GAS_YR22_ITEM_ID, TTF_ICE, GAS_PRODUCT_ID, \
    POWER_YEARS, POWER_2023_ITEM_ID, ITALY_BASELOAD, POWER_PRODUCT_ID
    ...
    return {"timestamp": timestamp,
            ...
            "data": [
                {"counter_party_ok": False, "system_rank": "487290945", "broker_id": broker_id, "txt": False,
                 ...
                 "is_tradable": True, "execution_restriction": "NON", "implied": False, "action": "MOD",
...
def create_feed(timestamp):
    ...
    for seq_id, instr_id, item_id, broker_id, price, quantity, direction, timestamps in [
        # Gas: item id 20 -> Gas Yr 21 (OCT21-OCT22), # item id 21 -> "Gas Yr 22"
        # Power: item id 19 => 2022 (JAN22-JAN23), # item id 20 => 2023
        (POWER_YEARS, ITALY_BASELOAD, POWER_2023_ITEM_ID, BROKER_ID, 600, QUANTITY, COMMON.Direction.buy, timestamp),
        (POWER_YEARS, ITALY_BASELOAD, POWER_2023_ITEM_ID, BROKER_ID, 800, QUANTITY - 1, COMMON.Direction.buy, timestamp+1),
        (POWER_YEARS, ITALY_BASELOAD, POWER_2023_ITEM_ID, BROKER_ID, 500, QUANTITY - 2,COMMON.Direction.buy, timestamp + 2),
        # Gas: item id 20 -> Gas Yr 21 (OCT21-OCT22), # item id 21 -> "Gas Yr 22"
    ]:
        feed.append(
            create_add_order(
