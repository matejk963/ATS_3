...
from baconv_strategy.constants import BROKER_ID_1, BROKER_ID_2, INST_ID_1, INST_ID_2, PRODUCT_ID_1, PRODUCT_ID_2, POWER_MONTHS, \
    POWER_ITEM_ID_1, POWER_ITEM_ID_2

PACKAGE_NAME = "baconv_strategy"
...
class SynthStratConfigTest(unittest.TestCase):
    def setUp(self):
        ...
        self.config = StrategyConfiguration(
            ...
            ba_conv_large_threshold = 0.5,
            ba_conv_small_threshold = 0.2,
