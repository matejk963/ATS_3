...
class SOTest(unittest.TestCase):
    file_path = r'Z:\Data\Spot\Model\Inputs\de_w1_w2_20240912_ba.csv'
    def test_model_mstd(self):
        # Load data
        with open(self.file_path, 'r') as file:
            data_list = [(float(a['bid'])+float(a['ask']))/2 for i, a in enumerate(csv.DictReader(file)) if i != 0]
        model_type = 'MSTD_x'
        params_list = [100, .0, 2]
        ...
        file_path_out = r'Z:\Data\Spot\Model\Inputs\data_model_mstd_x_20240912.txt'
