...
def create_feed(timestamp):
    ...
    for seq_id, instr_id, item_id, broker_id, price, direction in [
        ...
        (POWER_MONTHS, INST_ID_2, POWER_ITEM_ID_1, BROKER_ID_1, 76.09, COMMON.Direction.sell),
        (POWER_MONTHS, INST_ID_1, POWER_ITEM_ID_1, BROKER_ID_2, 76, COMMON.Direction.sell),
        (POWER_MONTHS, INST_ID_2, POWER_ITEM_ID_1, BROKER_ID_1, 76.07, COMMON.Direction.sell),
        (POWER_MONTHS, INST_ID_2, POWER_ITEM_ID_1, BROKER_ID_1, 76.15, COMMON.Direction.sell),

        (POWER_MONTHS, INST_ID_1, POWER_ITEM_ID_1, BROKER_ID_1, 74.83, COMMON.Direction.buy),
        (POWER_MONTHS, INST_ID_1, POWER_ITEM_ID_1, BROKER_ID_2, 75, COMMON.Direction.buy),
        (POWER_MONTHS, INST_ID_2, POWER_ITEM_ID_1, BROKER_ID_1, 74.92, COMMON.Direction.buy),
        (POWER_MONTHS, INST_ID_2, POWER_ITEM_ID_1, BROKER_ID_1, 74.93, COMMON.Direction.buy),
...
def create_trade_feed(timestamp):
    ...
    for seq_id, instr_id, item_id, broker_id, price, direction in [
        # Trade
        # Gas: item id 20 -> Gas Yr 21 (OCT21-OCT22), # item id 21 -> "Gas Yr 22"
        (POWER_MONTHS, INST_ID_1, POWER_ITEM_ID_1, BROKER_ID_1, 76.1, COMMON.Direction.buy),
        (POWER_MONTHS, INST_ID_1, POWER_ITEM_ID_1, BROKER_ID_1, 74.9, COMMON.Direction.sell)
...
class SynthStratConfigTest(unittest.TestCase):
    def setUp(self):
        ...
        self.config = StrategyConfiguration(
            ...
            cross_arb=False,
            cross_arb_margin_min=0.04,
            cross_arb_margin_max=0.15,
            min_time_cross=0.,
