...
class StrategyTemplate(TEMPLATE.BaseTemplate):
    ...
    cross_arb = TEMPLATE.StrategyConfigField("Cross arbitrage allowed",
                                             "Boolean for cross arbitrage ",
                                             bool, mandatory="always")

    cross_arb_margin_min = TEMPLATE.StrategyConfigField("Minimum margin cross arbitrage",
                                                        "Minimum margin for cross arbitrage",
                                                        float, mandatory="always")

    cross_arb_margin_max = TEMPLATE.StrategyConfigField("Maximum margin cross arbitrage",
                                                        "Maximum margin for cross arbitrage",
                                                        float, mandatory="always")

    min_time_cross = TEMPLATE.StrategyConfigField("Min time cross arbitrage",
                                                  "Minimum time for cross arbitrage repeated execution",
                                                  float, mandatory="always")
