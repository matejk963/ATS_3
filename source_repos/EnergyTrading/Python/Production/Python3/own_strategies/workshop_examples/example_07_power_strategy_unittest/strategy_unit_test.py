...
class TestWithOrderBook(SUTB.TestWithEpexProducts):
    ...
    def test_01_act(self):
        ...
        res_sell = placements[(self._09_10_prod_id, SELL_SLOTNAME)]
        res_buy = placements[(self._09_10_prod_id, BUY_SLOTNAME)]

        net_sell = '[i=sell_state:normal||trd:0.0||net_target_pos:0.0||rest:0.0||fronts:None//None]'
        net_buy = '[i=buy_state:normal||trd:0.0||net_target_pos:0.0||rest:0.0||fronts:None//None]'
        ...
        res_sell = placements[(self._10_11_prod_id, SELL_SLOTNAME)]
        res_buy = placements[(self._10_11_prod_id, BUY_SLOTNAME)]
