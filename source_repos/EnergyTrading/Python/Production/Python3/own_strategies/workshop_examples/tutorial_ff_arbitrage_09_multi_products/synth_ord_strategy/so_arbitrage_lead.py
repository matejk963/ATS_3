...
class ArbitrageOrder(SYB.SyntheticOrderBase):
    own_product_id = SYNCONF.SyntheticOrderConfigField(
        caption="own_product_id",
        description="Own Product ID, which is passed to the 2nd arbitrage leg synthetic order as 'other'",
