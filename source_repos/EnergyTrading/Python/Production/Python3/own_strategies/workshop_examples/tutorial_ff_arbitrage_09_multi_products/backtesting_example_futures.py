...
def create_feed(timestamp):
    ...
    for seq_id, instr_id, item_id, broker_id, price, direction in [
        ...
        (GAS_YEARS, TTF_ICE, GAS_YR22_ITEM_ID, BROKER_ID, 200, COMMON.Direction.sell),
        # Power: item id 19 => 2022 (JAN22-JAN23), # item id 20 => 2023
        (POWER_YEARS, ITALY_BASELOAD, POWER_2023_ITEM_ID, BROKER_ID, 600, COMMON.Direction.buy),
        (POWER_YEARS, ITALY_BASELOAD, POWER_2023_ITEM_ID, BROKER_ID, 800, COMMON.Direction.sell),
        # Gas: item id 20 -> Gas Yr 21 (OCT21-OCT22), # item id 21 -> "Gas Yr 22"
        (GAS_YEARS, TTF_ICE, GAS_YR22_ITEM_ID, BROKER_ID, 10, COMMON.Direction.buy),
        (GAS_YEARS, TTF_ICE, GAS_YR22_ITEM_ID, BROKER_ID, 10, COMMON.Direction.buy),
    ]:
        feed.append(
            create_add_order(
...
def get_synth_order_payload():
    return {
        ...
        "configuration": {
            ...
            "own_product_id": POWER_PRODUCT_ID,
