...
class PowerStrategyBacktest(unittest.TestCase):
    def test_01(self):
        ...
        # the folder name defines the simulated strategy (which code will run)
        # we will reuse this later also as strategy id
        ...
        # print out traded amounts to the terminal
