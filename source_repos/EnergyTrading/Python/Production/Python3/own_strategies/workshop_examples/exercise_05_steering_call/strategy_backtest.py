...
class PowerStrategyBacktest(unittest.TestCase):
    def test_01(self):
        ...
        # TASK: setup a strategy steering call to simulate a rest-API call on the strategy
        # TASK: use any of these imports if they are helpful:
        # import autotrader_lib.common as COMMON
        ...
        #######################################
        # TASK: setup a strategy configuration message,
        #  which changes the parameter trading_end_before_market_closure=5 and active=True
        strategy_config = None
        strategy_config.update(dict(active=True))
        strategy_config_msg = None
