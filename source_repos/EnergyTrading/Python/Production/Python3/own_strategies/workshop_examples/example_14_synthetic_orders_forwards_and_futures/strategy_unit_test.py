...
import own_strategies.workshop_examples.example_14_synthetic_orders_forwards_and_futures.futures_example_strategy.position_closing_so as PCSO  # noqa: E501
...
class Tests(unittest.TestCase):
    def test_slot_size_respected(self):
        ...
        additional_views_mock = mock.MagicMock()

        returned_slot = so.act(local_view_mock, additional_views_mock, timestamp_mock)
    ...
    def test_buybacks(self):
        ...
        local_view_mock.current_front_price = lambda x: 5. if x == COMMON.Direction.buy else 6.
        additional_view_mock = mock.MagicMock()

        returned_slot = so.act(local_view_mock, additional_view_mock, timestamp_mock)
