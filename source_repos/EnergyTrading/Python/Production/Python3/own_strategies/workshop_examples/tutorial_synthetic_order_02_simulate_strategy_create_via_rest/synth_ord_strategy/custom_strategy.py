...
log = logging.getLogger('autotrader.tutorial_synthetic_order_02_simulate_strategy_create_via_rest')
...
class CustomStrategy(SYSTRAT.SyntheticOrderStrategyBase):
    ...
    def on_strategy_configuration_update(self, strategy_json):
        ...
        self.debug_log("Received Registering SO products", self.strategy_settings["so_products"])
