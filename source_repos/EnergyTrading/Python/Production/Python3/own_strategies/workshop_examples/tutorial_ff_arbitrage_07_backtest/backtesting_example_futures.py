...
from synth_ord_strategy.constants import GAS_YEARS, TTF_ICE, GAS_YR22_ITEM_ID, TTF_BROKER_ID, THE_ICE, GAS_PRODUCT_ID
...
def get_synth_order_payload():
    return {
        ...
        "configuration": {
            ...
            # try to run this with different slot name and identifier to see the difference
...
class SynthStratConfigTest(unittest.TestCase):
    ...
    def test(self):
        ...
        sim = Simulator(
            event_messages=[rest_strat_msg_create,
                            limits_setup_message,
                            rest_strat_msg_activate,
                            so_register_msg],
            json_feed=feed,
        ...
        self.assertEqual(traded[GAS_PRODUCT_ID]['areas'][TTF_ICE]['net_volume'], 10)
