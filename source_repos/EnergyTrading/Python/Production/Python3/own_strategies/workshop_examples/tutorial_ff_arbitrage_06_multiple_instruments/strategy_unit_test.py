...
from synth_ord_strategy import so_arbitrage_lead as ABSO
...
class Tests(unittest.TestCase):
    ...
    def test_additional_view_with_high_buy_price(self):
        ...
        self.assertEqual(slot_with_additional_views.quantity, 1)  # quantity == QUANTITY_TICK_SIZE, defined in SO code
