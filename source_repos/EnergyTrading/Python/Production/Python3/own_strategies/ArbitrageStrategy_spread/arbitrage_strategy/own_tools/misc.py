...
def floor_div_to_tick(numerator, denominator, tick_size):
    # Step 1: Divide by tick size
    number_in_ticks = numerator / tick_size

    # Step 2: Floor division operation
    floored_ticks = number_in_ticks // denominator

    # Step 3: Multiply back by tick size
    result = floored_ticks * tick_size
