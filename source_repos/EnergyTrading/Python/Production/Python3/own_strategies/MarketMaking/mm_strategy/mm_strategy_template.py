...
class StrategyTemplate(TEMPLATE.BaseTemplate):
    ...
    broker1_ids = TEMPLATE.StrategyConfigField("List of Broker 1 IDs",
                                               "List of Broker IDs for leg 1 that strategy operates on, first is main",
                                               list, mandatory="always", default=["1441"])

    broker2_ids = TEMPLATE.StrategyConfigField("List of Broker 2 IDs",
                                               "List of Broker IDs for leg 2 that strategy operates on, first is main",
                                               list, mandatory="always", default=["1441"])
    ...
    max_margin = TEMPLATE.StrategyConfigField("Maximum lot Margin",
                                              "Quotation margin for maximum lot",
                                              float, mandatory="always")
    ...
    extended_logs = TEMPLATE.StrategyConfigField("Extended log enabled",
                                                 "Extended logging of model",
                                                 bool, mandatory="always")

    verbose = TEMPLATE.StrategyConfigField("Verbose mode enabled",
                                           "Verbose mode enabled, prints more information to log",
                                           bool, mandatory="always", default=False)

    venue_change_bool = TEMPLATE.StrategyConfigField("Venue change enabled",
                                                     "Venue change enabled, if True, the strategy will change "
                                                     "venue for orders if opposite is exchange",
                                                     bool, mandatory="always", default=False)
