...
class MarketMakingOrderBid(SYB.SyntheticOrderBase):
    ...
    def _price_check(self, our_price, exist_price, local_buy, local_sell):
        ...
        if our_price is None:
            ...
            if (local_buy is not None) and (local_buy - our_price > 1 * self.margin):
    ...
    def act(self, localview, additional_views, timestamp):
        ...
        log.debug(
            "[{}] MarketMakeBid, BROKER:{},  [Public BUY/SELL]: Local: {}[{}]: {}//{}".format(
        ...
        log.debug(
            "[{}] MarketMakeBid order placement: our_price: {} / quoting: {}".format(
