...
import placeholder_so as PSO

import logging
log = logging.getLogger('autotrader.example_12.so_slot_strategy')
...
class CustomStrategy(SYSTRAT.SyntheticOrderStrategyBase):
    ...
    def on_strategy_configuration_update(self, strategy_json):
        ...
        if "so_products" in self.strategy_settings:
    ...
    def get_available_synthetic_order_types(cls):
        return {"SimpleSyntheticOrder": PSO.SimpleSyntheticOrder}
