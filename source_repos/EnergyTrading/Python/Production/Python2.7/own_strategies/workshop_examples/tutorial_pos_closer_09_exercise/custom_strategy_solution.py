...
class CustomStrategy(STRAT.Strategy):
    ...
    def custom_act_for_product(self, log_data, product, timestamp, *args, **kwargs):
        ...
        slot.info = "mode: {}||trd: {}({})||net_target_pos: {}||rest: {}||order: {}@{}(tol: {})||fronts: {}//{}".format(
            mode, common_traded, traded_vals, open_position, rest, slot.quantity, slot.price, price_tolerance,
            best_public_buy_price, best_public_sell_price
        )
