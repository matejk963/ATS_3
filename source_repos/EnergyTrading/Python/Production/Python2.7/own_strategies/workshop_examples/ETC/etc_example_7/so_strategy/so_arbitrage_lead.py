...
class ArbitrageOrder(SOB.SyntheticOrderBase):
    ...
    def act(self, localview, additional_views, timestamp):
        ...
        print("view_ttf: %s : %s" % (view_ncg.current_front_price(COMMON.Direction.buy, self.broker_id), COMMON.Direction.buy))
        print("view_ttf: %s : %s" % (view_ncg.current_front_price(COMMON.Direction.sell, self.broker_id), COMMON.Direction.sell))
