...
class TestStratStoragePEG(SUTB.TestWithTrayportProducts):
    ...
    def test_02_send_timeseries(self):
        ...
        res_sell = slot_by_prod_and_name[(self.product_id_wd, NEW_STRATEGY.SELL_SLOTNAME)]
        res_buy = slot_by_prod_and_name[(self.product_id_wd, NEW_STRATEGY.BUY_SLOTNAME)]

        self.assertEqual(res_sell, (
            50.0, 720., "sell",
            "sell_state:normal||trd:0.0||net_target_pos:-720.0||rest:-720.0||order:720.0@50.0||fronts:None//None"))
        self.assertEqual(res_buy, (
            0.0, 0.0, "buy",
            'buy_state:normal||trd:0.0||net_target_pos:-720.0||rest:-720.0||order:0.0@-0.0||fronts:None//None'))

        res_sell = slot_by_prod_and_name[(self.product_id_da, NEW_STRATEGY.SELL_SLOTNAME)]
        res_buy = slot_by_prod_and_name[(self.product_id_da, NEW_STRATEGY.BUY_SLOTNAME)]
    ...
    def test_03_with_public_orderbook(self):
        ...
        self.assertEqual(res_sell, (
            50.0, 720., "sell",
            "sell_state:normal||trd:0.0||net_target_pos:-720.0||rest:-720.0||order:720.0@50.0||fronts:30.0//50.0"))
        self.assertEqual(res_buy, (
            0.0, 0.0, "buy",
            "buy_state:normal||trd:0.0||net_target_pos:-720.0||rest:-720.0||order:0.0@-0.0||fronts:30.0//50.0"))
    ...
    def test_04_with_own_trades(self):
        ...
        self.assertEqual(res_sell, (
            50.0, 1200.0, "sell",
            "sell_state:normal||trd:480.0||net_target_pos:-720.0||rest:-1200.0||order:1200.0@50.0||fronts:30.0//50.0"))
        self.assertEqual(res_buy, (
            0.0, 0.0, "buy",
            "buy_state:normal||trd:480.0||net_target_pos:-720.0||rest:-1200.0||order:0.0@-0.0||fronts:30.0//50.0"))
        ...
        self.assertEqual(res_sell, (
            50.0, 480.0, "sell",
            "sell_state:normal||trd:-240.0||net_target_pos:-720.0||rest:-480.0||order:480.0@50.0||fronts:None//None"))
        self.assertEqual(res_buy, (
            0.0, 0.0, "buy",
            "buy_state:normal||trd:-240.0||net_target_pos:-720.0||rest:-480.0||order:0.0@-0.0||fronts:None//None"))
...
class TestStratStorageTTF(SUTB.TestWithTrayportProducts):
    ...
    def test_01_act(self):
        ...
        self.assertEqual(res_sell, (
            50.025, 12.0, "sell",
            "sell_state:normal||trd:0.0||net_target_pos:-12.0||rest:-12.0||order:12.0@50.025||fronts:None//None"))
        self.assertEqual(res_buy, (
            0.0, 0.0, "buy",
            "buy_state:normal||trd:0.0||net_target_pos:-12.0||rest:-12.0||order:0.0@-0.0||fronts:None//None"))
