...
def send_html_email(recipient, subject, text_content, html_content, attachment_path=None, recipient_cc=[], smtp_server="smtp.office365.com", smtp_port=587, email_address="algotrading@energytrading.sk", email_login=None, email_password="", ):
    if email_login is None:
        email_login = email_address
    msg = EmailMessage()
    msg["Subject"] = subject
