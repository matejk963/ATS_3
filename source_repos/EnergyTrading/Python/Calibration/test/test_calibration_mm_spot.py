...
if __name__ == '__main__':
    ...
    start_date_t = datetime(2024, 6, 27)
    ...
    fix_param_val = [datetime(2024, 11, 28), .5, 1.5, 0.035]
    ...
    if mm_model in ['mstd', 'mstd_tr']:
        ...
        opt_param_val = [np.arange(5, 20, .5),
                         np.arange(0.1, 0.5, 0.1), np.arange(0.5, 1.5, 0.5),
        ...
        opt_param = ['tau',
                     'take_profit', 'stop_loss_rat',
                     'w', 'w_std']
        opt_param_val = [np.arange(5, 20, 1),
                         np.arange(0.1, 0.5, 0.1), np.arange(0.75, 1.25, 0.25),
