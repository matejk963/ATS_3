...
class LLStrategyCalibration(Calibration):
    ...
    def calibrate_p(self, data_lag, data_lead,  backtest_class, opt_params,  method='mean', multip=True, cpu_percent=90, instr='m2'):
        ...
        if multip:
            out_dict = self.calibrate_single_multip(data_lag, data_lead,
                                         backtest_class,
    ...
    def calibrate_single_multip(self, data_lag, data_lead, backtest_class,
                          params_s_dict, cpu_percent, instr):
        ...
        static_data = {
            ...
            'data_lead': data_lead.reset_index(),
    ...
    def async_task(cls, strategy_data, static_data, params):
        ...
        data_lead = static_data['data_lead']
        ...
        if not cls.update_opt_param(params):
            return None
        out_ser = cls.simulate_single(data_lag, data_lead,
        ...
        output=output+[num_trades, trades_per_day]

        return {key: output}

    def simulate_single(self, data_lag, data_lead, backtest_class, params_dict, instr):
        ...
        # Simulate strategy
        return backtest_class.simulate_strategy(self.strategy, instr, data_lag, data_lead)
