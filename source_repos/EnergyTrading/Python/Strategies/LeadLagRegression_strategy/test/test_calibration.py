...
if __name__ == '__main__':
    ...
    data_lag = pd.read_csv(r's:\Algo\Files\andrej\Data\int_data_lag_dem2_may_june.csv',
                           parse_dates=['datetime']).reset_index()
    ...
    opt_param = ['MACD_short_threshold', 'MACD_long_threshold', 'price_diff_long_threshold', 'price_diff_short_threshold',
    ...
    opt_param_val = [[1, 5, 10, 30, 45, 60], [3, 5, 7, 9, 13, 17, 19], [0.01, 0.1, 0.2, 0.3, 0.4],
