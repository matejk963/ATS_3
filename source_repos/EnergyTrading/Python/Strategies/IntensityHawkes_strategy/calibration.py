...
class HIStrategyCalibration(Calibration):
    ...
    def calibrate_p(self, backtest_class, model_class,
                    opt_params, model_params,  method='mean', multip=True, cpu_percent=90):
        self.strategy.train_model()
        data = self.strategy.model.return_data_dict()[self.strategy.model.products[0]]
        print(data.head())
        ...
        if multip:
            out_dict = self.calibrate_single_multip(data,
    ...
    def calibrate_single_multip(self, data_tests, backtest_class,
                         model_class,model_params, params_s_dict, cpu_percent):
    ...
    def async_task(cls, strategy_data, static_data, params):
        ...
        cls.strategy.model.params_dict = strategy_data['model_params']
    ...
    def simulate_single(self, data_tests, backtest_class, params_dict):
