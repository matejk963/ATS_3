...
class Consumption(external_fund_data):
    ...
    def adjust_normal(self):
        ...
        for market in self.unique_markets:
            ...
            norm_curve = self.normal_fund_data_raw[market].copy()
    ...
    def get_normal_data_raw(self):
        for market in self.unique_markets:
            if market not in self.normal_fund_data_raW:
                market_source = enums.get_normal_data_source(market)
                self.normal_fund_data_raw[market] = self.data_loader.get_fund_raw_data('normal',
                                                                            self.fund_type,
                                                                            self.ec_type,
                                                                            market,
    ...
    def get_normal_data(self):
        self.get_normal_data_raw()
        self.normal_fund_data = self.adjust_normal
