from fund_analysis.input_data.coal import Coal
...
coal_inst = Coal(params_dict)
gas_inst = Gas(params_dict)

# ef_inst.fund_type = 'CON'
gas_inst.get_curve()
gas_curve = gas_inst.fut_matrix
gas_da = gas_inst.da_data
coal_inst.get_curve(gas_curve=gas_curve,
                    gas_da=gas_da)