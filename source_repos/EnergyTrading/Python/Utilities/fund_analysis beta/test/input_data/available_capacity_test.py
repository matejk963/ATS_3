...
params_dict['sD'] = dt.datetime(2024,1,1)
params_dict['eD'] = pd.to_datetime(dt.datetime.today().date())
params_dict['eD'] = dt.datetime(2024,3,12)
params_dict['ns'] = 2
params_dict['cont'] = False

cap_inst = AvailableCapacityData(params_dict, cap_type='av_cap', unique_markets_list=['de', 'fr'])

# ef_inst.fund_type = 'CON'
cap_inst.get_curve()
# cap_inst.get_da_data()
