# -*- coding: utf-8 -*-
"""
Created on Mon Sep  2 09:20:03 2024
...
bT = datetime(2024, 8, 28)
eT = datetime(2024, 10, 1) - timedelta(hours=1)
...
positions_['de'] = {'M': {'base': {datetime(2024,9,1): [[-1, 92.35],
                                                        [-1, 90.25],
                                                         [1, 89.4],
                                                         [-1, 89.5],
                                                         [-1, 81.77],
                                                         ...
                                                         [1,104.75],
                                                         [-1, 101.6]]}},
                    'W': {'base': {datetime(2024,8,26): [[-2*7/31, 98.1]],
                                   datetime(2024,9,2): [[-1*7/31, 99.0]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,9,1): [[-1, 65.5],
                                                        [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,9,1): [[1, 87.75],
                                                        [1, 84.95],
                                                         [1, 83],
                                                         [1, 75.97],
                                                         [1, 56.66],
                                                         ...
                                                         [-1, 59.1],
                                                       [-1, 113.55]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,9,1): [[-1, 99.3],
                                                        [1, 91.25],
                                                       [-1, 115.45]]}},
                    'W': {'base': {datetime(2024,8,26): [[2*7/31, 133.1]],
                                   datetime(2024,9,2): [[1*7/31, 142.5]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,9,1): [[-1, 115],
                                                       [-1, 110.55]]}}}
...
print(pd.DataFrame([pd.DataFrame({k: out_dict[k].loc[d, :] * v * 24 * 30
                                  for k, v in vol_dict.items()}).T.sum().sum() + (hdg.loc[d, :] * 24 * 30).sum().sum()
