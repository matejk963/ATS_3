# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 10:24:43 2024
...
bT = datetime(2024, 3, 28)
eT = datetime(2024, 4, 10) - timedelta(hours=1)
...
vol_dict = {'at_de': 5, 'be_de': 2, 'dkw_nl': 1, 'de_dke': 1,
...
price_dict = {'at_de': 1.49, 'be_de': 5.6, 'dkw_nl': 7.33, 'de_dke': 1.48,
...
positions_['de'] = {'M': {'base': {datetime(2024,4,1): [[-1, 86.56],
                                                        [-1, 68.7],
                                                        [-1, 68.15],
                                                        [-1, 67.03],
                                                        [-1, 63.23],
                                                        ...
                                                        [1, 55.37],
                                                         ...
                                                         [1,104.75],
                                                         [-1, 101.6]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,4,1): [[-1, 93.75],
                                                      [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,4,1): [[1, 85.81],
                                                        [1, 66.9],
                                                        [1, 66.45],
                                                        [1, 64.53],
                                                        [1, 59.23],
                                                        ...
                                                        [-1, 52.87],
                                                       [-1, 113.55]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,4,1): [[-1, 98.14],
                                                       [-1, 115.45]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,4,1): [[-1, 89.51],
                                                       [-1, 115],
                                                       [-1, 110.55]]}}}
