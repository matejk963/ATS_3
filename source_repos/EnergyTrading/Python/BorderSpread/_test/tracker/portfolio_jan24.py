...
bT = datetime(2023, 12, 31)
eT = datetime(2024, 2, 1) - timedelta(hours=1)
...
positions_['de'] = {'M': {'base': {datetime(2024,1,1):[[1, 86.81],
                                                      [-1, 86.06],
                                                      [-1, 86.11],
                                                      [1, 88.6],
                                                      [1, 87.44],
                                                      ...
                                                      [1,104.75],
                                                      [-1, 101.6]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,1,1): [[-1, 91.81],
                                                       [-1, 93.75],
                                                       [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,1,1): [[1, 84.11],
                                                       [1, 84.06],
                                                       [-1, 113.55]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,1,1): [[-1, 98.14],
                                                       [-1, 115.45]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,1,1): [[-1, 89.51],
                                                       [-1, 115],
                                                       [-1, 110.55]]}}}
