...
eT = datetime(2023, 10, 1) - timedelta(hours=1)
...
xx = out_dict['de_at'] + out_dict['at_de'] - (3 / 6)*(out_dict['atmb2309s'] - out_dict['demb2309l'])
xy = out_dict['de_at'] + out_dict['at_hu'] - (6 / 8)*(out_dict['humb2309s'] - out_dict['demb2309l'])
