...
eT = datetime(2024, 5, 1) - timedelta(hours=1)
...
positions_['de'] = {'M': {'base': {datetime(2024,4,1): [[-1, 51.78],
                                                        [1, 55.65],
                                                        [-1, 74.45],
                                                        [-1, 76.2],
                                                        [-1, 81.08],
                                                        ...
                                                        [-1, 55.71],
                                                         ...
                                                         [1,104.75],
                                                         [-1, 101.6]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,4,1): [[-1, 81.25],
                                                        [-1, 66.1],
                                                        [-1, 56.8],
                                                      [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,4,1): [[1, 47.53],
                                                        [-1, 40.15],
                                                        [1, 70],
                                                        [1, 71.6],
                                                        [1, 75.58],
                                                        ...
                                                        [1, 46.35],
                                                       [-1, 113.55]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,4,1): [[-1, 63.05],
                                                        [1, 57.43],
                                                       [-1, 115.45]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,4,1): [[1, 56.91],
                                                       [-1, 115],
                                                       [-1, 110.55]]}}}
