# -*- coding: utf-8 -*-
"""
Created on Wed Oct 16 14:12:24 2024
...
bT = datetime(2024, 9, 28)
eT = datetime(2024, 11, 1) - timedelta(hours=1)
...
positions_['de'] = {'M': {'base': {datetime(2024,10,1): [[-1, 83.5],
                                                         [1, 105.5],
                                                         [1, 102.44],
                                                         [1, 103.7],
                                                         [1, 87.65],
                                                         ...
                                                         [1,104.75],
                                                         [-1, 101.6]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,10,1): [[-1, 84.8],
                                                        [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,10,1): [[1, 67.5],
                                                        [-1, 110.9],
                                                        [-1, 91.8],
                                                        [1, 76.75],
                                                        [-1, 88.1],
                                                        ...
                                                        [1, 91.18],
                                                        [-1, 113.55]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,10,1): [[-1, 112.44],
                                                       [-1, 115.45]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,10,1): [[-1, 110.65],
                                                        [-1, 115],
                                                       [-1, 110.55]]}}}
