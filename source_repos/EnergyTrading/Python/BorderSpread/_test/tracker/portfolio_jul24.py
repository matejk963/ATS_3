...
bT = datetime(2024, 6, 28)
eT = datetime(2024, 8, 1) - timedelta(hours=1)
...
positions_['de'] = {'M': {'base': {datetime(2024,7,1): [[-1, 92.35],
                                                        [-1, 90.25],
                                                         [1, 89.4],
                                                         [-1, 89.5],
                                                         [-1, 81.77],
                                                         ...
                                                         [1,104.75],
                                                         [-1, 101.6]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,7,1): [[-1, 65.5],
                                                        [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,7,1): [[1, 87.75],
                                                        [1, 84.95],
                                                         [1, 83],
                                                         [1, 75.97],
                                                         [1, 56.66],
                                                         ...
                                                         [-1, 59.1],
                                                       [-1, 113.55]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,7,1): [[-1, 99.3],
                                                        [1, 91.25],
                                                       [-1, 115.45]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,7,1): [[-1, 115],
                                                       [-1, 110.55]]}}}
