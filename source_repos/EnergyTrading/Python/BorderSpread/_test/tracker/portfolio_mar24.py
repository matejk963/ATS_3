...
bT = datetime(2024, 2, 28)
eT = datetime(2024, 4, 1) - timedelta(hours=1)
...
vol_dict = {'at_de': 5, 'be_de': 2, 'dkw_nl': 1,
            'be_nl': 2, 'de_at': 5, 'de_be': 2, 'de_nl': 2,
            'nl_be': 2, 'nl_de': 2, 'cz_de': 3, 'de_cz': 2,
            'at_hu': 2, 'hu_at': 2, 'at_cz': 2, 'cz_at': 2,
            'sk_cz': 1, 'hu_sk': 1, 'be_fr': 4, 'fr_be': 4}

price_dict = {'at_de': 1.49, 'be_de': 5.6, 'dkw_nl': 7.33,
...
positions_['de'] = {'M': {'base': {datetime(2024,3,1): [[-1, 86.56],
                                                        [-1, 68.7],
                                                        [-1, 68.15],
                                                        [-1, 67.03],
                                                        [-1, 63.23],
                                                        ...
                                                        [1, 55.37],
                                                         ...
                                                         [1,104.75],
                                                         [-1, 101.6]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,3,1): [[-1, 93.75],
                                                      [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,3,1): [[1, 85.81],
                                                        [1, 66.9],
                                                        [1, 66.45],
                                                        [1, 64.53],
                                                        [1, 59.23],
                                                        ...
                                                        [-1, 52.87],
                                                       [-1, 113.55]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,3,1): [[-1, 98.14],
                                                       [-1, 115.45]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,3,1): [[-1, 89.51],
                                                       [-1, 115],
                                                       [-1, 110.55]]}}}
