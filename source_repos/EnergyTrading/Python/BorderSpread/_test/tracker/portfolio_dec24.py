# -*- coding: utf-8 -*-
"""
Created on Mon Dec  2 14:52:03 2024
...
bT = datetime(2024, 11, 28)
eT = datetime(2025, 1, 1) - timedelta(hours=1)
...
positions_['de'] = {'M': {'base': {datetime(2024,12,1): [[1*1, 83.5],
                                                         [1, 105.5],
                                                         [1, 102.44],
                                                         [1, 103.7],
                                                         [1, 87.65],
                                                         ...
                                                         [1,104.75],
                                                         [-1, 101.6]]}},
                    'W': {'base': {datetime(2024,12,16): [[2*7/31, 88.175]]}}}
positions_['cz'] = {'M': {'base': {datetime(2024,12,1): [[-1, 84.8],
                                                        [1, 105.4]]}}}

positions_['fr'] = {'M': {'base': {datetime(2024,12,1): [[-1*1, 83.05],
                                                        [-1, 110.9],
                                                        [-1, 91.8],
                                                        [1, 76.75],
                                                        [-1, 88.1],
                                                        ...
                                                        [1, 91.18],
                                                        [-1, 113.55]]}},
                    'W': {'base': {datetime(2024,12,16): [[-2*7/31, 91.15]]}}}
positions_['hu'] = {'M': {'base': {datetime(2024,12,1): [[-1, 112.44],
                                                       [-1, 115.45]]}}}
positions_['at'] = {'M': {'base': {datetime(2024,12,1): [[-1, 110.65],
                                                        [-1, 115],
                                                       [-1, 110.55]]}}}
