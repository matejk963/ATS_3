# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 09:30:26 2023
...
bT = datetime(2023, 9, 25)
eT = datetime(2023, 11, 1) - timedelta(hours=1)
...
vol_dict = {'fr_be': 4, 'be_fr': 4, 'be_nl': 1, 'nl_be': 2,
            'de_be': 2, 'de_nl': 2, 'de_dkw': 6,
            'de_at': 14, 'at_hu': 7, 'de_cz': 8, 'cz_de': 10,
            'cz_at': 7, 'at_cz': 7, 'at_si': 2}
...
fwd_list = [forward('de', 99.44, sD, 'M', 'base'),
            forward('at', 100.56, sD, 'M', 'base'),
            forward('cz', 102.82, sD, 'M', 'base'),
            forward('hu', 110.84, sD, 'M', 'base'),
            forward('fr', 92.25, sD, 'M', 'base')]
fwd_pos_list = [16, -5, -5, -5, -1]

###

### Load data for spot & futures
mkt_list_s = ['de', 'at', 'hu', 'cz', 'si', 'fr', 'be', 'nl', 'dkw']
dict_df_fwd = {}
