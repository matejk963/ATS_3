...
bT = datetime(2023, 11, 25)
eT = datetime(2024, 1, 1) - timedelta(hours=1)
...
vol_dict = {'de_at': 8, 'at_de': 8, 'at_hu': 2, 'hu_at': 2,
            'at_cz': 2, 'cz_at': 5, 'cz_de': 2, 'de_cz': 2,
            'cz_sk': 4, 'sk_cz': 8, 'sk_hu': 1, 'hu_sk': 4,
            'de_be': 1, 'dkw_de': 1, 'dkw_nl': 1}
