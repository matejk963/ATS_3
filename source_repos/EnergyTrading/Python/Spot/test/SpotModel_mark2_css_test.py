...
base_products = ['M_1', 'M_2', 'M_3', 'Q_1', 'Q_2', 'Q_3']
...
scen_dict = {dt.datetime(2024,7,22):{'liq':{}},
             dt.datetime(2024,7,23):{'liq':{}},
             dt.datetime(2024,7,24):{'liq':{}},
             dt.datetime(2024,7,25):{'liq':{}},
             dt.datetime(2024,7,26):{'liq':{}}}

scen_dict = {dt.datetime(2024,7,26):{'liq':{}}}

spread_dict = pm_inst.get_css(model_params_dict, scen_dict)
